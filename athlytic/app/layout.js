          ...
          <aside className="w-64 bg-white border-r flex flex-col p-4">
            ...
            <nav className="flex-1">
              <ul className="space-y-2">
                <li>
                  <Link href="/dashboards" className="block px-3 py-2 rounded hover:bg-indigo-50 font-medium text-gray-700">
                    Dashboard
                  </Link>
                </li>
                <li>
                  <Link href="/ai-insights" className="block px-3 py-2 rounded hover:bg-indigo-50 font-medium text-gray-700">
                    AI Insights
                  </Link>
                </li>
                <li>
                  <Link href="/metrics" className="block px-3 py-2 rounded hover:bg-indigo-50 font-medium text-gray-700">
                    Metrics
                  </Link>
                </li>
                <li>
                  <Link href="/connections" className="block px-3 py-2 rounded hover:bg-indigo-50 font-medium text-gray-700">
                    Connections
                  </Link>
                </li>
                <li>
                  <Link href="/settings" className="block px-3 py-2 rounded hover:bg-indigo-50 font-medium text-gray-700">
                    Settings
                  </Link>
                </li>
              </ul>
