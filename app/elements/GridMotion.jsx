...
const GridMotion = ({ items = [], gradientColor = 'black' }) => {
  ...
  useEffect(() => {
    // Set initial mouseX position based on window width
  ...
  const renderContent = (content) => {
    if (typeof content === 'string') {
      ...
      return <div className="p-4 text-center z-[1]">{content}</div>;
    }
    // If content is not a string, assume it's a React element
    return <div className="p-4 text-center z-[1]">{content}</div>;
  };
